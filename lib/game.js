(function() {
  ...
  Game.prototype.drawOver = function (ctx) {
    ...
    var endText = this.ship.hits < 1 ? "Game Over" : "You win!!";
    ctx.fillText(endText, this.DIM_X / 3.25, this.DIM_Y / 2.5);
  ...
  Game.prototype.checkCollisions = function () {
    ...
    for (var i = 0; i < this.allObjects.length - 1; i++) {
      if (this.allObjects[i].type === "Asteroid") {
        asteroids += 1;
      }
    ...
    if (asteroids === 0 || this.ship.hits < 1) { this.over = true; }
  };
